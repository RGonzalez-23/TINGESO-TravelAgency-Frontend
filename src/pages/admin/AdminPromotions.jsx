          ...
          <div className="modal-content glass-card">
            ...
            <form onSubmit={handleSave} className="promo-form">
              <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem', fontWeight: '600', color: 'black' }}><Tag size={16} /> Nombre Comercial de la Oferta</label>
              ...
              {errorMsg && <div style={{ color: '#dc2626', marginBottom: '1.5rem', padding: '1rem', background: '#f22727ff', borderRadius: '8px' }}>{errorMsg}</div>}
